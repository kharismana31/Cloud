...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2017 at 07:34 PM
...
-- Database: `fpcloud`
--
CREATE DATABASE IF NOT EXISTS `fpcloud` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fpcloud`;
...
INSERT INTO `ambil_matakuliah` (`nrp`, `idjadwal`) VALUES
('5114100024', 1),
('5114100024', 2),
('5114100024', 3),
('5114100024', 4),
...
--
ALTER TABLE `jadwal`
  MODIFY `idjadwal` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `matakuliah`
--
ALTER TABLE `matakuliah`
  MODIFY `idmk` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
