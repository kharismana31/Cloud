...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-12 text-center">
            <img style="width: 40%; height: auto; margin-top: 10%; margin-bottom: -3%;" src="<?php echo asset_url();?>img/title_login.png">
        </div>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url('login/aksi_login'); ?>" method="post">
                            <fieldset>
                                ...
                                <button type="submit" value="Login" class="btn btn-lg btn-success btn-block">Login</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
