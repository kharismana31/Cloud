...
<head>
    ...
    <title>Sistem Akademik - FP Cloud Computing</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo asset_url();?>bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="<?php echo asset_url();?>metisMenu/metisMenu.min.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">SISTEM AKADEMIK - FINAL PROJECT CLOUD COMPUTING</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <p class="text-center">Login as <br> <b><?php echo $this->session->userdata("nama"); ?></b></p>
                        <li class="divider"></li>
